...
export default function Achivements() {
  return (
    <div className="achive-maindiv">
      <h2 style={{color:'#55198b',fontSize:'3.25vw',fontFamily:'font-family: Arial, sans-serif',textAlign:'center'}}>Achivements</h2>
      <div className="achivements-wrapper">
        <div className="achivement-div">
          <img
          alt=""
          src={require("../images/hackerrankcertificate.png")} />
          <h3 style={{color:'#55198b',fontSize:'2vw',fontFamily:'font-family: Arial, sans-serif',textAlign:'center', margin:'0'}}>HackerRank Problem Solving (Basic) Certificate</h3>
          <p>
        ...
        <div className="achivement-div">
          ...
          alt=""
          />
          <h3 style={{color:'#55198b',fontSize:'2vw',fontFamily:'font-family: Arial, sans-serif',textAlign:'center', margin:'0'}}>HackerRank Problem Solving (Intermediate) Certificate</h3>
          <p>
      ...
      <div className="achivements-wrapper">
        <div className="achivement-div">
          ...
          <h3 style={{color:'#55198b',fontSize:'2vw',fontFamily:'font-family: Arial, sans-serif',textAlign:'center', margin:'0'}}>IRCAMME Reserch Paper Presentation</h3>
          <p>
        ...
        <div className="achivement-div">
          ...
          alt=""
          />
          <h3 style={{color:'#55198b',fontSize:'2vw',fontFamily:'font-family: Arial, sans-serif',textAlign:'center', margin:'0'}}>Automobiles & Electric vehicle internship Certificate</h3>
          <p>
        ...
        <div className="achivement-div" style={{marginLeft:'auto',marginRight:'auto'}}>
          ...
          alt=""
          />
          <h3 style={{color:'#55198b',fontSize:'2vw',fontFamily:'font-family: Arial, sans-serif',textAlign:'center', margin:'0'}}>The Power Project award</h3>
          <p>
